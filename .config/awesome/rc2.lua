...
naughty.config.presets.normal.opacity = 0.2
naughty.config.presets.low.opacity = 0.2
naughty.config.presets.critical.opacity = 0.2
    end)
end
-- }}}
...
beautiful.init("/home/caleb/.config/awesome/themes/caleb/theme.lua")
local exec   = awful.util.spawn
home = os.getenv("HOME")

-- This is used later as the default terminal and editor to run.
terminal = "xfce4-terminal"
editor = os.getenv("EDITOR") or "nano"-- Wifiwidget
wifiwidget = wibox.widget.textbox()
vicious.register(wifiwidget, vicious.widgets.wifi, "<span color='#D4D7F2'>~</span> 
${link}%", 5, "wlp8s0")
...
beautiful.awesome_icon },
                                    { "lock", "xscreensaver-command --lock" },
                                    {"configure", "gedit 
/home/caleb/.config/awesome/rc.lua"}
                                  }
                        })
...
menubar.utils.terminal = terminal -- Set the terminal for applications that require 
it
-- }}}
...
volicon:set_image("/home/caleb/.config/awesome/icons/vol.png")
...
for s = 1, screen.count() do
    ...
    -- Create an imagebox widget which will contains an icon indicating which layout 
we're using.
    -- We need one layoutbox per screen.
    mylayoutbox[s] = awful.widget.layoutbox(s)
    mylayoutbox[s]:buttons(awful.util.table.join(
                           awful.button({ }, 1, function () awful.layout.inc(layouts, 
1) end),
                           awful.button({ }, 3, function () awful.layout.inc(layouts, 
-1) end),
                           awful.button({ }, 4, function () awful.layout.inc(layouts, 
1) end),
                           awful.button({ }, 5, function () awful.layout.inc(layouts, 
-1) end)))
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "j", function () awful.screen.focus_relative( 1) 
end),
    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus_relative(-1) 
end),
    awful.key({ modkey,           }, "u", awful.client.urgent.jumpto),
    awful.key({ modkey,           }, "Tab",
    awful.key({ modkey, "up"      }, "XF86AudioRaiseVolume", function ()
    awful.util.spawn("amixer set Master 9%+", false) end),
    awful.key({ modkey, "down"    }, "XF86AudioLowerVolume", function ()
    awful.util.spawn("amixer set Master 9%-", false) end),
    ...
    awful.key({ modkey,           }, "space", function () awful.layout.inc(layouts,  
1) end),
    awful.key({ modkey, "Shift"   }, "space", function () awful.layout.inc(layouts, 
-1) end),
...
awful.util.spawn_with_shell("xbacklight -inc 50")
...
&)")
awful.util.spawn_with_shell("tidybattery")
--awful.util.spawn_with_shell("nitrogen --restore")
awful.util.spawn_with_shell("compton ~/.config/compton.conf")
awful.util.spawn_with_shell("sleep 5 ; xrandr --output HDMI1 --mode 1920x1080 --above 
LVDS1")
awful.util.spawn_with_shell("synapse")
--awful.util.spawn_with_shell("conky -c /home/caleb/conkyrcweather")
--awful.util.spawn_with_shell("conky -c /home/caleb/.conkyrcclock")
--awful.util.spawn_with_shell("conky -c /home/caleb/.conkyrc")
